...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(//scaffold automatically adds back button so no need to use 'pop' concept
      //coloring in between left over space by GRIDS
          ...
          : GridView.count(
              ...
              children: pokeHub.pokemon
                  .map((Pokemon poke) => Padding(
                      ...
                      child: InkWell(
                        //we can also use GestureDetector
